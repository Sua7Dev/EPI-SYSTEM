    ...
    with st.container():
        try:
            ...
            if timeframe == "Año":
                ...
                cursor = conn.cursor()
                cursor.execute("SELECT DISTINCT strftime('%Y', fecha_registro_formulario) FROM morbilidad ORDER BY 1 DESC")
                ...
                pdf_buffer = 3#exportar_pdf_Morbilidad_general(year=year)
                ...
                pdf_buffer = 2#exportar_pdf_Morbilidad_general(specific_date=specific_date)
                ...
                if end_date >= start_date:
                    pdf_buffer = 1#exportar_pdf_Morbilidad_general(start_date=start_date, end_date=end_date)

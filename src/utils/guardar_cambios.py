...
def procesar_guardado_cambios_mortalidad_neonatal(edited_df):
    """
...
def procesar_guardado_cambios_mortalidad_infantil(edited_df):
    """
...
def procesar_guardado_cambios_mortalidad_materna(edited_df):
    """
...
def procesar_guardado_cambios_mensual_neonatal(edited_df):
    """
...
def procesar_guardado_cambios_mensual_infantil(edited_df):
    """
...
def procesar_guardado_cambios_mensual_general(edited_df):
    """
...
def procesar_guardado_cambios_natalidad(edited_df):
...
def procesar_guardado_morb_extenso(edited_df):
    """
...
def procesar_guardado_morb_simplificado(edited_df):
    """
...
def procesar_guardado_cambios_reg_diario(edited_df):

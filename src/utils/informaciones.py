...
def alcance_del_sistema():
    with st.expander("Alcance del Sistema", icon=":material/info:", width="stretch", expanded=True):
        ...
        st.markdown("""
        El sistema **SEE** está diseñado para la gestión integral de datos epidemiológicos en entornos hospitalarios. Su alcance incluye:
...
def proposito_del_sistema():
    with st.expander("Propósito del Sistema", icon=":material/ads_click:", width="stretch", expanded=True):
        ...
        st.markdown("""
        El propósito fundamental de **SEE** es optimizar la vigilancia epidemiológica mediante el uso de tecnologías de la información. Sus objetivos principales son:
